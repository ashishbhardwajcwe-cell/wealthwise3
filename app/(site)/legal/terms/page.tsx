...
export const metadata: Metadata = {
  ...
  description: "Terms of service for PlanMyCashflows website and CashFlow Planner application.",
};
...
export default function TermsPage() {
  return (
    <LegalPage
      title="Terms of Service"
      subtitle="The terms governing your use of this website and the CashFlow Planner application."
      lastUpdated="28 May 2026"
      sections={[
        {
          heading: "1. Acceptance of terms",
          content: [
            `By accessing or using ${siteConfig.url} or the CashFlow Planner application, you agree to these Terms of Service. If you do not agree, please do not use our services.`,
          ],
        },
        {
          heading: "2. Educational content only",
          content: [
            `All content on ${siteConfig.url} and the CashFlow Planner application is provided strictly for educational and informational purposes. Nothing on this site or in the application constitutes investment, legal, accounting, or tax advice.`,
        ...
        },
        {
          ...
          content: [
            "You agree to provide accurate information when using the AI Wealth Planner, registering for the CashFlow Planner app, or contacting us.",
            "You will not use the services for unlawful purposes, attempt to reverse-engineer our software, or scrape content at scale.",
            "You are responsible for maintaining the confidentiality of your CashFlow Planner account credentials.",
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            "We may suspend or terminate your access to the CashFlow Planner app for breach of these terms, fraud, or if required by law.",
