      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-[var(--color-slate)] mt-1 leading-relaxed">
            {authorRole ?? "Founder of Auris Wealth. Ex-Indian Army (20 years). NISM-certified Investment Adviser. Writes about wealth management for Indian and global investors."}
          </p>
        </div>
      </div>
    </div>
