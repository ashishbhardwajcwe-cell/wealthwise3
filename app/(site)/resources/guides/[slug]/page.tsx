        ...
        <div className="container-narrow">
          ...
          <div className="mt-12 p-6 md:p-8 bg-[var(--color-navy)] text-[var(--color-cream)] rounded-2xl">
            ...
            <p className="text-[var(--color-silver)] mb-6 leading-relaxed">
              The PlanMyCashflows Planner turns this framework into a personalised plan in 60 seconds. Or book a free 30-minute call with our team.
            </p>
          ...
          <div className="mt-12 p-6 bg-white border border-[var(--color-silver)]/40 rounded-xl">
            <h4 className="font-semibold text-[var(--color-navy)]">PlanMyCashflows Research</h4>
            <p className="text-sm text-[var(--color-slate)] mt-1 leading-relaxed">
              The research desk at PlanMyCashflows writes guides like this one for Indian and global
              investors who want clarity, not products.
            </p>
          </div>
