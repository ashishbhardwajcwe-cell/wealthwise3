  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-4">
        <CalcInput label="Current age" value={age} setValue={setAge} min={20} max={70} step={1} />
        <CalcInput label="Target retirement age" value={retireAge} setValue={setRetireAge} min={age + 1} max={75} step={1} />
        <CalcInput label="Life expectancy" value={lifeExp} setValue={setLifeExp} min={retireAge + 1} max={100} step={1} />
        <CalcInput label="Monthly expenses today (₹)" value={monthlyExp} setValue={setMonthlyExp} min={10000} max={1000000} step={5000} />
        <CalcInput label="Current invested corpus (₹)" value={currentCorpus} setValue={setCurrentCorpus} min={0} max={500000000} step={100000} />
        <CalcInput label="Inflation % p.a." value={inflation} setValue={setInflation} min={2} max={12} step={0.5} />
        <CalcInput label="Return pre-retirement %" value={returnPre} setValue={setReturnPre} min={4} max={18} step={0.5} />
        <CalcInput label="Return post-retirement %" value={returnPost} setValue={setReturnPost} min={3} max={12} step={0.5} />
      </div>
