  ...
  const tiers = [
    ...
    },
    {
      ...
      features: [
        ...
        { label: "2x annual 1:1 product walkthrough (how to use the planner tools — not financial advice)", on: true },
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Quarterly in-person product training sessions", on: true },
