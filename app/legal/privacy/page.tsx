      ...
      sections={[
        ...
        },
        {
          ...
          content: [
            ...
            "**In the WealthWise app:** Account details, portfolio holdings, financial goals — strictly to provide the service. Read-only API tokens where applicable.",
          ],
        },
        {
          heading: "3. How we use your data",
          content: [
            "**To deliver the service:** Run the AI Wealth Planner, build your WealthWise plan, respond to enquiries, send the newsletter you opted into.",
        ...
        },
        {
          ...
          content: [
            ...
            "WealthWise app data: retained while your account is active + 12 months after deletion request, then permanently purged (longer if required by tax or regulatory law).",
        ...
        },
        {
          ...
          content: [
            ...
            "WealthWise app data is encrypted at rest in our database.",
