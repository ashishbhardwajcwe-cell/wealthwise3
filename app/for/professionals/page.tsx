  ...
  return (
    <AudienceLanding
      content={{
        ...
        intro: [
          "Most mid-career professionals have a salary, a home loan, an EPF, a couple of mutual funds, maybe some ESOPs, term insurance someone&apos;s spouse sold them, and a vague worry that &ldquo;something might be off.&rdquo;",
        ...
        commonSituations: [
          {
            title: "&ldquo;I&apos;m 35, earning ₹40L, with ₹50L invested — am I on track?&rdquo;",
          ...
          {
            title: "&ldquo;I have ₹80L in my employer&apos;s stock — should I sell?&rdquo;",
          ...
          {
            title: "&ldquo;I switched to new tax regime two years ago — was that right?&rdquo;",
          ...
          {
            title: "&ldquo;Buy a home now or keep renting?&rdquo;",
